...
<div class="modal-row">
                            ...
                            <div class="modal-row">
                                ...
                                <div class="modal-record-col2">
                                    <div class="slds-form-element__control  ">
                                        <FormTextBoxField 
                                            v-model.trim="subCategoryData.title" fieldId="subCategory_name"
                                    ...
                                    <div class="mb-0 user-modal-desc">
                                        <div class="slds-form-element__control ">
                                            <FormTextareaField v-model.trim="subCategoryData.description"
                                                ...
                                                className="slds-input custom-grid-input" fieldId="subCategory_desc" :bindValue="`${subCategoryData.description}`" @keypress="checkInput()"/>
