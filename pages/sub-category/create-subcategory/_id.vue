            ...
            <div class="main-card">
                <div class="role-main">
                    <div class="mb-18 back-text">
                        ...
                        <nuxt-link :to="`/sub-category/${subCategoryData.parent_category_id}`"><span>BACK </span></nuxt-link>
                    </div>
                            ...
                            <div class="modal-row">
                                ...
                                <div class="modal-record-col2">
                                    <div class="slds-form-element__control  ">
                                        <formSelectField 
                                            v-model="subCategoryData.parent_category_id" :category-list="SubCategoryAllData"
                                            class="slds-select mb-20 custom-grid-input" id="select-01" :value="subCategoryData.parent_category_id"/>
...
export default {                                                                                                                                                                                                                                                                                                                                    
    ...
    created(){
        ...
        console.log(this.subCategoryData.parent_category_id);
    ...
    methods: {
        ...
        addSubCategory(e) {
            ...
            if (this.subCategoryData.parent_category_id && this.subCategoryData.title && this.subCategoryData.description) {
                    CategoryService.addCategory(this.subCategoryData).then((result) => {
