...
export default {
    ...
    created() {
        this.header = ["", 'Sr No.', 'Course Name', 'Major Category','Sub Category','Created On', 'Status', 'Action'];
            ...
            CourseService.getCourseList(value, page).then(
                function (response) {
                    ...
                    response.data.data.data.map(function (value, key) {
                        ...
                        temp_array.category_title = "Test";
                        temp_array.sub_category_title = value.entity_sub_category_relation.course_sub_categoryrelation[0].title;
