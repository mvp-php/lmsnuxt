...
- `<New folderCompoCourseList>` | `<new folder-compo-course-list>` (components/New folder/Compo/courseList.vue)
- `<New folderCompoCreateCource>` | `<new folder-compo-create-cource>` (components/New folder/Compo/createCource.vue)
